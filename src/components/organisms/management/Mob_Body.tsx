...
export const Mob_Pagination = styled.View`
  opacity: 0.8;
...
export const Mob_Pagination_Items = styled.TouchableOpacity`
  flex:1;
  flex-direction: row;
  justify-content: center;
  align-self: center;
...
`;
export const Mob_Pagination_Text = styled.Text`
text-align: center;
font-size: 4px;
`;
...
export const Mob_TouchableOpacity_button = styled.TouchableOpacity`
 flex:1;
 display: flex;
 flex-wrap: nowrap;
 flex-direction: row;
...
export const Mob_Sub_Bar_Data_Data_View = styled.View<{ $is_active:boolean;$is_completed:boolean }> `
 flex:1;
 display: flex;
 flex-direction: row;
 justify-content: space-evenly;
