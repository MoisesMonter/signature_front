...
import { Colors, Pages_Colors, Header_Colors, Flags_Colors } from "../../../components/colors";
...
color: ${Colors.title}
`
export const Web_List_Input_TextInput = styled.TextInput<{$Widths:string ; $Heights:string}>`
border-radius: 0.7vh;
background-color: ${Colors.New_White};
width: ${(props:any)=>{ return props.$Widths+'vh'}};
height:auto;
min-height:${(props:any)=>{ 
  if(props.$Heightws != '') return props.$Heights+'vh'
    else return '18vh'}} ;
max-height: '5vh';
