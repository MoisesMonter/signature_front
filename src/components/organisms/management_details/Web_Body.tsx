...
export const Web_Bar_Info = styled.View`
  ...
  border-radius: 0.5vh;
  background-color: ${Colors.title2};
  /* margin-bottom: 5vh; */
`;
...
export const Web_Children_Data_Info_View = styled.View<{$direction:string ; $Wghts:string; $align:string ; $gap:string ; $Wdhts:string} >`
  flex:1;
  ...
  max-height:${(props:any)=>{
    if(props.$Wghts !== '') return (props.$Wghts)+'vh'
    else return '1vh'
  }};
  max-width:${(props:any)=>{
  ...
  gap:${(props:any)=>{
    if(props.$gap !== '') return (props.$Wghts *0.1)+'vh'
    else return '0vh'
  }};
...
export const Web_Children_Data_Info_Input = styled.TextInput<{$sizeinputheight:string}>`
    width: 40vh;
    outline-color: ${Colors.primary};
    height: auto;
    min-height:  ${(props:any)=>{
      if (props.$sizeinputheight != '') return (props.$sizeinputheight)+'vh'
      else return '10vh';
    }};;
    max-height: '10vh';
    font-size: 2vh;
